...
#### 7) Ler o arquivo [extrato_vendas.csv](anexos/extrato_vendas.csv) e apresentar os vendedores com maior valor de venda por região.
...
#### 12) Crie uma tabela de alunos com as propriedades: 
	Matricula (inteiro), 
	Nome (Texto),
	Idade (inteiro), 
	Estado (texto)
...
#### 17) Dado uma gravadora, crie um sistema em que seja possível:
	• Cadastrar um novo artista ou banda (Nome, Quantidade de integrantes, Ritmo)
	• Alterar informações de um artista cadastrado
	• Remover artista do portfolio
	• Consultar os artistas do portfolio
	• Cadastrar álbuns (Nome, artista, Ritmo)
	• Alterar informações de um álbum cadastrado
	• Remover álbum do portfolio
	• Consultar os álbuns do portfolio
